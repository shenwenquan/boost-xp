...
#ifndef BOOST_XP_THREAD_POOL_TEST_H
#define BOOST_XP_THREAD_POOL_TEST_H
...
boost::unique_future<void> p(boost::unique_future<void> f) {
    assert(f.is_ready());
        ...
        {
            {
                ...
                {
                    boost::unique_future<int> t1 = boost::async(ea, &f1);
                    boost::unique_future<int> t2 = boost::async(ea, &f1);
                ...
                std::cout << BOOST_CONTEXTOF << std::endl;
                {
                    ...
                    std::cout << BOOST_CONTEXTOF << std::endl;
                    boost::unique_future<int> t1 = boost::async(ea3, &f1);
                    std::cout << BOOST_CONTEXTOF << std::endl;
                    boost::unique_future<int> t2 = boost::async(ea3, &f1);
                    std::cout << BOOST_CONTEXTOF << std::endl;
...
#endif //BOOST_XP_THREAD_POOL_TEST_H
